...
## Index: Week and Day-wise Topics

### [Week 1](materials/week-01/README.md) — LLM Foundations & Core Agentic Patterns
...
| Days 6–7 | Build Your First Complete Agent Application (Personal Research Assistant) |

---

### [Week 2](materials/week-02/README.md) — Multi-Agent Systems, Evaluation & Production
...
| Days 13–14 | Capstone Project (Multi-Agent Customer Support System) |

---

### [Week 3](materials/week-03/README.md) — Bootcamp for Tool Mastery & Assignments

Use the track resources (Track A, Track B, Track C) [full doc](materials/AI-Engineer-Bootcamp-Tracks.md). Pick one and follow its table, then complete the **Phase 1 & 2 Shared Capstone**.
